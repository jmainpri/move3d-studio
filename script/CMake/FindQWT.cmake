...
find_path (QWT_INCLUDE_DIR qwt_plot.h 
  PATHS ${QWT_INC} /opt/local/include /usr/local/include /usr/include /sw/include 
...
find_library (QWT_LIBRARIES qwt-qt4 qwt
  PATHS ${QWT_LIB} /opt/local/lib /usr/local/lib /usr/lib /lib /sw/lib 
  )
