...
TrajectorySamplingWidget::TrajectorySamplingWidget(QWidget *parent) :
    QWidget(parent),
    m_ui(new Ui::TrajectorySamplingWidget)
{
    m_ui->setupUi(this);
    init();
}

TrajectorySamplingWidget::~TrajectorySamplingWidget()
{
    delete m_ui;
}
...
//    new SpinBoxSliderConnector( this, m_ui->doubleSpinBoxRadius, m_ui->horizontalSliderRadius, PlanEnv->getObject(PlanParam::starRadius));
    new SpinBoxConnector( this, m_ui->doubleSpinBoxHessianFactor, PlanEnv->getObject(PlanParam::lamp_hessian_factor));
    new SpinBoxConnector( this, m_ui->doubleSpinBoxStdDev,PlanEnv->getObject(PlanParam::trajOptimStdDev));
    new SpinBoxConnector( this, m_ui->doubleSpinBoxControlCost,PlanEnv->getObject(PlanParam::lamp_control_cost));
    new SpinBoxConnector( this, m_ui->doubleSpinBoxEta,PlanEnv->getObject(PlanParam::lamp_eta));

    // n
    new SpinBoxConnector( this, m_ui->spinBoxNbSamples, PlanEnv->getObject(PlanParam::lamp_nb_samples));
}
